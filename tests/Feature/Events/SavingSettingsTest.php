...
describe('saving settings event', function (): void {
    test('stores pre-save event payload', function (): void {
        $target = ResolutionTarget::app();
        $event = new SavingSettings('SettingsClass', ['apiToken' => 'secret'], $target, 'subject');
